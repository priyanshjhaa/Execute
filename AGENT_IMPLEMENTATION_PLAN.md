...
## Phase 5: Memory and Context Limits

- Keep the latest eight messages in active context.
- Add rolling summaries capped near 700 tokens.
- Add request and response length limits.
