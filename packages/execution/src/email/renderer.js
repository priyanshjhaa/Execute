...
function renderHTML(content) {
    const { heading, intro, body, details, ctaText, ctaLink, signatureName, replyHint, urgency, showBranding = true, showFooter = true, showReplyHint = true, } = content;
...
function renderText(content) {
    const { heading, intro, body, ctaText, ctaLink, signatureName, replyHint, showBranding = true, showFooter = true, showReplyHint = true, } = content;
    const lines = [];
    // Heading
